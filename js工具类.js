...
// 原文地址:https://blog.csdn.net/kuangshp128/article/details/71104988
 ...
 *  ��������animate
 *  ���ܣ�ѡ��Ԫ�أ���ָ���ٶ��ƶ���Ŀ��λ��
 *  ������ele-ָ��Ԫ�أ�valX-Ŀ��λ��xֵ��valY-Ŀ��λ��yֵ��ti-�ƶ�һ�ε�ʱ����
 *  ����ֵ����
 */

var timer1;
var timer2;
function animate(ele, valX, valY, ti) {
    if(!ti) {
        ti = 30;
    }
    ...
    //�������ظ����룬��Ҫ�Ľ�
    function fn1(){
        //����Ŀ��λ��Ϊ500px��ʵ��λ��Ϊ200px��������λ�� = ��ʼλ�ã�ʵ��λ�ã�+��Ŀ��λ��-��ʼλ�ã�
